# Prototyping & Code — Agent Instructions

> **Scope:** This file governs code, tooling, and infrastructure work only. For analytical documents (requirements, user stories, solution design) and repo-level rules, `instructions/agent.md` takes precedence. When the two files conflict, **`agent.md` wins**.
